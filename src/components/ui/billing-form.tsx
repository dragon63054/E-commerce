...
const formSchema = z.object({
  ...
  expires: z.string().min(4, { message: "Expires is required" }),
              ...
              <FormField
                ...
                render={({ field: { name, value, onChange, ...rest } }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select value={value} onValueChange={onChange} name={name} {...rest}>
                        <SelectTrigger>
              ...
              <FormField
                ...
                render={({ field: { name, value, onChange, ...rest } }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Select name={name} value={value} onValueChange={onChange} {...rest}>
                        <SelectTrigger id="year">Year</SelectTrigger>
                        <SelectContent>
